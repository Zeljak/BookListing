...
public class QueryUtils {
    ...
    private static List<Book> extractFeatureFromJson(String bookJSON) {
        ...
        //**Try to parse the JSON response string. If there is a problem with the way JSON is formatted,
        //**JSONException exception object will be thrown.
        ...
        try {
            ...
            //**For each book int the bookArray, create an {@link Book} object
            for (int i = 0; i < bookArray.length(); i++) {

                //**Get a single book at position i within the list of
                JSONObject currentBook = bookArray.getJSONObject(i);

                //**For a given book, extract the JSONObject associated with the
                //key called "volumeInfo", which represents a list of all properties for the book.
                ...
                Book book = new Book(name, authors, url, description);
            ...
            //catch the exception here, so the app does not crash. Print a log message with the message from the exception.
